...
* [**Evolution**](https://github.com/chaoss/wg-evolution): This working group was focused on refining the metrics that inform evolution and to work with open source software implementations.

* [**Value**](https://github.com/chaoss/wg-value): This working group was focused on developing metrics that describe value of open source engagement for individuals and organizations.


## 2. Context Working Group
...
* [**OSPO++**](https://docs.google.com/document/d/1ZZg8vGQOgfhK6P6G8GQse6OaN3yb2Z_IQVyINa-0TZs/edit): The OSPO++ working group aims create a set of recommendations for metrics related to university open source software, particularly as they relate to what might be seen as “success” for university leadership, faculty, students, and staff, keeping in mind that these actors may evaluate success differently. 

* [**Science**](https://github.com/chaoss/wg-science): The Science working group aims create a set of recommendations for metrics and models related to scientific open source community. 

## 3. Operations Working Group
The Operations Working Groups are supporting the metrics discussions and are responsible for various activities and operations for the CHAOSS project.

* [**Communications**](https://docs.google.com/document/d/1_2hErJemNCLgIBaOW0ODIdwfbgBqTfw25aJ7E1ijzWc/edit): The Communications working group focuses on defining the communication policy for CHAOSS. 
...
* [**CHAOSScast**](https://podcast.chaoss.community/about): The CHAOSScast working group focuses on managing CHAOSS podcast. 

* [**DEI Badging**](https://github.com/badging/): The DEI Badging working group focuses on badging initiative that is meant to encourage open source projects and event organizers to obtain our Diversity, Equity, and Inclusion badges for the purposes of leadership self-reflection and self-improvement around the ways that they are centering DEI. 
